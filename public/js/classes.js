...
class Fighter extends Sprite {
  ...
  update() {
    ...
    // attack boxes
    if (this.facingLeft) {
          this.attackBox.position.x = this.position.x - this.attackBox.offset.x - 110  
        } else {
    ...
    // Draw the attack box in different colors for player and enemy
    // c.save()
    // c.fillStyle = this.color === 'blue' ? 'rgba(0, 0, 255, 0.3)' : 'rgba(255, 0, 0, 0.3)'
    // c.fillRect(
